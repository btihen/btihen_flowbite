---
layout: post
title:  "Building a Bridgetown Blog-site"
date:   2022-06-28 00:59:53 +0200
categories: post_ruby_rails
---

## Bridgetown with Tailwind
```
...
## Install Flowbite CSS

```
npm i flowbite
```

load its javascripts - open `frontend/javascript/index.js` and add:
```
import 'flowbite'
```

Now configure Tailwind to be aware of Flowbite open `tailwind.config.js
```
module.exports = {
  content: [
...
## Navbar LOGO
* Zen Brush 3 - bold lines for icon (save as png with transparent background)
* Affinity Photo - save as svg
Copy to the images folder:
```
          ...
          <div class="container mx-auto px-4">
            <div class="flex flex-wrap -mx-4">
              <div class="mx-auto relative w-10/12 mlg:w-8/12">
                <h3 class="text-3xl font-bold leading-normal mt-0 mb-2">Page Title</h3>
                <h6 class="text-md mt-2 mb-0 text-gray-600">March 1, 2019</h6>
                <article class="pt-2">
                  <%= yield %>
                </article>
              </div>
...
<footer class="p-4 mt-6 bg-blue-100 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
...
w if you go back to http://localhost:4000/posts and click on the link for the new post:
