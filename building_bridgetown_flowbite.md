Build Bridgetown Blog / Website

Bridgetown with Flowbite
========================
...
# now with Tailwind - install flowbite
...
config flowbite with tailwind.config.js
```
...
<html lang="<%= site.locale %>">
  ...
  <body class="<%= resource.data.layout %> <%= resource.data.page_class %>">
    ...
    <header class="bg-yellow-50 border-b-2 border-b-blue-50 shadow-sm">
      <div class="max-w-7xl mx-auto py-4 px-4 xs:px-4 sm:px-6 lg:px-8">
        <h1 class="text-lg leading-6 font-semibold text-gray-900">Page-Name</h1>
      </div>
    </header>

    <main>
      <div class="bg-yellow-50 max-w-7xl mx-auto py-6 xs:px-4 sm:px-6 lg:px-8">
        <%= yield %>
      </div>
    </main>
...
```
<nav class="bg-blue-100 border-blue-400 px-2 sm:px-4 py-2.0 rounded dark:bg-gray-800">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
  <a href="https://btihen.me/" class="flex items-center">
      <img src="images/btihen.svg" class="mr-3 h-6 sm:h-9" alt="btihen Logo" />
